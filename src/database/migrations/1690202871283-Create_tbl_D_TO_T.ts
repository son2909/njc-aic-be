...
export class CreateTblDTOT1690202871283 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE IF NOT EXISTS d_to_t (
        ...
        unit_price INT,
        spare CHAR(40),
        product_name_standard_size CHAR(255),
        comment_code_1 INT,
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('DROP TABLE IF EXISTS d_to_t;');
  }
}
